      ...
      <body className="font-body antialiased">
          ...
          >
            ...
            <footer className="py-6 md:px-8 md:py-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="w-full text-center md:h-16 flex items-center justify-center gap-6">
                    <a
                        href="https://www.linkedin.com/in/tigran-babujyan/"
                        target="_blank"
                    ...
                    <a
                        href="https://github.com/TigranBabujyan"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors"
